        ...
        echo "<div class='col-md-4 mb-2'>
          ...
          <div class='col-md-8'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-6'>
                                <p>!!!! Dont just wait grab <br>your product !!!!<br>&#128515;  	&#128516;</p>
                            </div>
                        </div>
                    </div>";
      }
...
{
  //whether ip is from the share internet for cart
...
//cart function(each user has their own ip address)
function cart()
{
...
function cart_item()
{
  ...
  function total_cart_price()
  {
    ...
    {
      $product_id=$row['product_id'];
      //combining two table (amount and is in different table)
